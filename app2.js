...
const promise = $.ajax({
       ...
       (data)=>{
              ...
              let documentNode = document.querySelectorAll('.question-container')

              console.log (documentNode)

              for (let i=0; i<documentNode.length; i++) {
                     for (let k=0; k<documentNode[i].length; k++) {
                            for (let j=0; j<documentNode[i][k].length; j++) {
                                   console.log (documentNode[i][k][j])
                            }
                     }
